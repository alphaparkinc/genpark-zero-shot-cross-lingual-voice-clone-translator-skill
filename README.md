# genpark-zero-shot-cross-lingual-voice-clone-translator-skill
...
> **GenPark AI Agent Skill** -- Zero-shot cross-lingual voice cloning translator & lip-sync engine (HeyGen style)
